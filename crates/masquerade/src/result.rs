...
impl DiagnosticCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::InvalidBitDepth => "invalid_bit_depth",
            ...
            Self::InvalidInfoHeader => "invalid_info_header",
            Self::InvalidPixelData => "invalid_pixel_data",
            Self::InvalidPlanes => "invalid_planes",
